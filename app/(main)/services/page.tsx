  ...
  const values = [
    {
      ...
      description:
        "We pour our expertise into every project, building spaces that truly reflect quality workmanship and attention to detail.",
    },
    {
      icon: Target,
      title: "Goal-Oriented Building",
      description:
        "Focused on delivering construction results that exceed expectations and transform your space through skilled craftsmanship.",
    },
    {
      icon: Lightbulb,
      title: "Creative Construction Solutions",
      description:
        "Innovative approaches to interior construction challenges, using traditional techniques with modern materials.",
    },
    {
      icon: CheckCircle,
      title: "Quality Construction Assured",
      description:
        "Meticulous attention to construction details ensures every built element meets our exceptionally high standards.",
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        "We assess your space, discuss construction requirements, and understand your functional needs for the building project.",
    },
    {
      step: "02",
      title: "Construction Planning",
      description:
        "Our team creates detailed construction plans, structural drawings, and material specifications for the build.",
    },
    {
      step: "03",
      title: "Material Procurement",
      description:
        "We source quality construction materials, coordinate deliveries, and prepare the site for building work.",
    },
    {
      step: "04",
      title: "Construction & Build",
      description:
        "Our skilled craftsmen execute the construction work, building every element with precision and quality control.",
    },
  ];
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              >
                We are skilled interior crafters dedicated to building spaces
                that inspire, function perfectly, and reflect quality
                workmanship. With over a decade of construction experience, we
                transform ordinary spaces into extraordinary built environments.
              </motion.p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                These core principles guide everything we build, ensuring that
                every construction project we undertake reflects our commitment
        ...
        <section className="py-20 bg-background">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                We follow a proven construction methodology that ensures your
                building project runs smoothly from planning to completion,
                keeping you informed and involved throughout the entire
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <h2 className="text-4xl font-bold text-foreground">
                  Meet Our{" "}
                  <span className="text-gradient">Expert Craftsmen</span>
                </h2>
                <p className="text-muted-foreground leading-relaxed">
                  Our diverse team of craftsmen, carpenters, and construction
                  specialists work collaboratively to ensure every detail of
                  your building project is executed flawlessly. With combined
                  decades of construction experience, we bring traditional
                  craftsmanship, technical expertise, and passion to every
                  build.
                </p>
                <div className="bg-card rounded-2xl p-6 shadow-card">
                  <blockquote className="text-lg italic text-muted-foreground leading-relaxed">
                    "Craftsmanship is not just what it looks like and feels
                    like. Craftsmanship is how it's built. We create spaces that
                    work beautifully for your life through quality
                    construction."
                  </blockquote>
                  <footer className="mt-4">
                    <cite className="text-accent font-semibold">
                      — Mkraft Interiors Craftsmen Team
                    </cite>
                  </footer>
                </div>
              </motion.div>
